...
export default function DataBox({data, rawData, previewImage }) {
      ...
      >
        ...
        <Stack direction="row" spacing={1} mt={1}>
          ...
          <Stack direction="row" alignItems="center" justifyContent="space-between" spacing={2}>
            ...
            {editMode && <Button variant='outlined' startIcon={<Edit />}>Edit</Button>}
          </Stack>

        </Stack>
        {console.log(rawData.previewImageUrl)}
        <Box
          width={250}
          height={200}
          component="img"
